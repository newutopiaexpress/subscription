...
<div className="col-span-12 md:col-span-5 p-4 lg:p-12 border-r border-stone-300 relative hover:bg-stone-100/10 content-center">
  ...
  <UtopiaLogo/>
  <p className="mt-2 text-sm text-stone-500 w-64">Tools that make your yourney to the singularity smoother.</p>
</div>
...
<div className="col-span-12 md:col-span-3 p-4 lg:p-12 border-r border-stone-300 relative content-center hover:bg-stone-100/10">
  <div className="absolute right-4 top-4 text-xs">
    <Link href="https://search.utopia.express/">
...
<div className="col-span-12 md:col-span-3 p-4 lg:p-12 border-r border-stone-300 relative content-center hover:bg-stone-100/10">
  <div className="absolute right-4 top-4 text-xs">
    <Link href="https://voice.utopia.express/">
    voice.utopia.express
    </Link>
  </div>
  <h2 className="font-bold text-lg mt-6">
    Voice Assistant
